...
insert into restaurante (nome, taxa_frete, cozinha_id, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro) values ("Thai Gourmet", 10, 1, 9, 580123111, "Avenida Cupixanga", 234, "Portão azul", "Agrião");
insert into restaurante (nome, taxa_frete, cozinha_id, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro) values ("Thai Delivery", 9.50, 1, 10, 58054999, "Avenida Prostibur", 871, "Placa de alerta no portão", "Cacimba de Dentro");
insert into restaurante (nome, taxa_frete, cozinha_id, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro) values ("Tuk Tuk Comida Indiana", 15, 2, 4, 58046600, "Avenida Hilton Souto Maior", 6701, "Quadra 756, Lote 22", "Portal do Sol");
